...
public class RefreshLayout extends ViewGroup {
    ...
    private boolean canFootRefresh = true;
    ...
    public boolean isCanFootRefresh() {
        return canFootRefresh;
    }

    public void setCanFootRefresh(boolean canFootRefresh) {
        this.canFootRefresh = canFootRefresh;
    }
    ...
    private boolean footerTouchEvent(MotionEvent ev) {
        ...
        switch (action) {
            ...
            case MotionEvent.ACTION_CANCEL:
                ...
                if (canFootRefresh&&action == MotionEvent.ACTION_UP && -yDiff > mFooterDistanceToTriggerSync) {
