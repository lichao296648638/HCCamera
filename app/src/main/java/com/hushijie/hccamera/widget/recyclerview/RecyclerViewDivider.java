 ...
 * Created by zhangkun on 2017/5/13.
 */
...
public class RecyclerViewDivider extends RecyclerView.ItemDecoration {
    ...
    public RecyclerViewDivider(int dividerHeight, Context context){
        this(context, LinearLayoutManager.VERTICAL,dividerHeight, Color.TRANSPARENT);
    }
